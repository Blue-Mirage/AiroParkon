            ...
            {product.subProducts.map((subProduct) => (
              <Box key={subProduct.id} sx={{ mb: 4 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
                  {/* Space for written description from https://www.i-stron.com/vertipark.php */}
                </Typography>
